...
/**
 * EditListingModal
 * Modern slide-in panel from the right for editing a listing.
 * Composed of smaller sub-components from ./edit/
 */
      ...
      <div className="fixed right-0 top-0 bottom-0 z-[160] w-full max-w-md bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-6 space-y-8">
            ...
            {/* Section: Basic info */}
            <EditSectionBasic form={form} errors={errors} setField={setField} />
