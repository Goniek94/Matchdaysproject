      ...
      <div className="container-max relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <motion.h2
            ...
            className="text-5xl md:text-7xl font-black text-black tracking-tight leading-[0.95] mb-8"
          >
            We represent the <br />
          ...
          <motion.p
            ...
            className="text-xl text-gray-500 leading-relaxed font-medium max-w-2xl"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[300px]">
          ...
          <motion.div
            ...
            className="md:col-span-2 row-span-2 relative group overflow-hidden rounded-3xl bg-black p-8 flex flex-col justify-between"
          >
            ...
            <div className="relative z-10 mt-8 h-48 bg-gray-900/50 rounded-xl border border-white/10 overflow-hidden backdrop-blur-sm">
          ...
          <motion.div
            ...
            className="md:col-span-1 row-span-2 relative group overflow-hidden rounded-3xl bg-gray-50 border border-gray-200 p-8 flex flex-col"
          >
          ...
          <motion.div
            ...
            className="md:col-span-1 relative group overflow-hidden rounded-3xl bg-gradient-to-br from-red-600 to-orange-600 p-8 text-white flex flex-col justify-between"
          >
            <div className="absolute top-4 right-4">
              <ArrowUpRight className="w-6 h-6 opacity-50 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
            </div>
            <Globe2 className="w-10 h-10 mb-4" />
            <div>
              <h3 className="text-xl font-bold mb-1">27 Countries.</h3>
              <p className="text-red-100 text-sm">One Market. Zero Borders.</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="md:col-span-1 relative group overflow-hidden rounded-3xl bg-white border border-gray-200 p-8 flex flex-col justify-between hover:shadow-xl transition-all duration-300"
          >
          ...
          <motion.div
            ...
            className="md:col-span-2 lg:col-span-4 relative group overflow-hidden rounded-3xl bg-gray-900 p-8 flex items-center justify-between"
          >
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20"></div>

            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-around w-full gap-8">
              ...
              <div className="text-center md:text-left">
                <div className="text-4xl md:text-5xl font-black text-yellow-500 mb-1">
                  100%
                </div>
                <div className="text-gray-400 text-sm uppercase tracking-widest font-bold">
                  Verified Items
              ...
              <div>
                <button className="px-8 py-4 bg-white text-black font-bold rounded-full hover:bg-gray-200 transition-colors uppercase tracking-wide text-sm">
                  Join the Revolution
                </button>
              </div>
            </div>
