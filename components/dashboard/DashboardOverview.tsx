  ...
  return (
    <div style={{ background: "#f9f8f6", minHeight: "100%" }}>
      ...
      <header
        ...
        style={{
          background:
            "linear-gradient(145deg, #0f0e0b 0%, #16121e 55%, #100e0b 100%)",
      ...
      >
        ...
        <div className="relative flex items-stretch">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {isVerified ? (
                  ...
                  <Link
                    href="/settings"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold hover:opacity-80"
                    style={{
                      color: "#fb923c",
                ...
                <Link
                  href="/add-listing"
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-[11px] font-black text-white hover:opacity-90"
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <span
                  style={{
                    background:
                      "linear-gradient(90deg, #fbbf24 0%, #f97316 45%, #a78bfa 100%)",
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {isPaid ? (
                  ...
                  <>
                    ...
                    <Link
                      href="/pricing"
                      className="inline-flex items-center gap-1 text-[11px] font-black px-3 py-1.5 rounded-full transition-all hover:opacity-90"
                      style={{
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {/* Pasek postępu - używamy zmiennej 'progress', aby błąd buildu zniknął */}
                  <div className="w-32 h-1 bg-white/10 rounded-full overflow-hidden">
                    <div
                      className="h-full transition-all duration-500"
                      style={{ width: `${progress}%`, background: dot }}
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <Zap
                    size={10}
                    style={{ color: aiCredits === 0 ? "#f87171" : "#38bdf8" }}
                  />
                  <span
                    className="text-[14px] font-black tabular-nums"
                    style={{ color: aiCredits === 0 ? "#f87171" : "#38bdf8" }}
          ...
          {/* ── RIGHT: stats ── */}
          <div
            className="flex-shrink-0 w-[42%] grid grid-cols-2"
          ...
          >
            {[
              ...
              },
              {
                label: "AI Credits",
                value: aiCredits,
                color: aiCredits === 0 ? "#f87171" : "#38bdf8",
              ...
              <div
                key={s.label}
                className="flex flex-col justify-between px-5 py-5 relative"
                style={{
                  borderTop:
              ...
              >
                ...
                <p
                  className="text-[2.6rem] font-black tabular-nums leading-none"
                ...
                <div
                  className="absolute bottom-0 left-5 right-5 h-px rounded-full opacity-30"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 min-h-0">
        ...
        <section
          ...
          style={{ borderRight: "1px solid #e6e3da" }}
        >
          {/* Tabs */}
          <div
            className="flex items-center gap-0.5 px-6 pt-5 pb-0 overflow-x-auto"
            ...
            {(["listings", "collection", "favorites", "bids"] as const).map(
              (tab) => (
                <button
                  ...
                  style={
                    contentTab === tab
                      ? { background: "#0d0c09", color: "#fff" }
                      : { background: "transparent", color: "#a8a49a" }
                  }
                >
                  {TAB_LABELS[tab]}
                </button>
          ...
          <div
            className="mx-6 mt-3"
            style={{ height: 1, background: "#edeae2" }}
          />
              ...
              <>
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-14 text-center">
                    ...
                    <p className="text-xs mb-5" style={{ color: "#a8a49a" }}>
                    ...
                    {activeItems.map((listing, idx) => {
                      ...
                      return (
                        <Link
                          ...
                          style={{
                            borderTop:
                              idx > 0 ? "1px solid #f0ede6" : undefined,
                          }}
                        >
                          <div
                    ...
                    {endingSoon.length > 0 && (
                      ...
                      >
                        ...
                        <p className="text-xs font-bold text-red-600">
                          ...
                          {endingSoon.length > 1 ? "s" : ""} ending within 3
                          hours
                        </p>
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                      {collectionPreview.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className="aspect-[3/4] rounded-xl overflow-hidden relative mb-2 bg-gray-100 transition-all duration-200 group-hover:-translate-y-0.5 group-hover:shadow-md"
                            ...
                            >
                              ...
                              {(item as any).isVintage && (
                                <span className="absolute top-2 left-2 px-1.5 py-0.5 bg-black/80 text-white text-[7px] font-black rounded uppercase tracking-wider">
                                  Vintage
                                </span>
                              )}
              ...
              <>
                {favLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-14 text-center">
                    ...
                    <p className="text-xs mb-6" style={{ color: "#a8a49a" }}>
                      Heart listings you love to save them here
                    </p>
                    <Link
                      href="/auctions"
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black text-white hover:opacity-90"
                      style={{ background: "#0d0c09" }}
                    >
              ...
              <>
                {bidsLoading ? (
                    ...
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex gap-4 animate-pulse">
                        ...
                        <div className="w-16 space-y-1.5 pt-1">
                          ...
                          <div className="h-3 rounded bg-gray-100 w-2/3 ml-auto" />
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-14 text-center">
                    ...
                    <p className="text-xs mb-6" style={{ color: "#a8a49a" }}>
                      Auctions you&apos;re currently bidding on will appear here
                    </p>
                    <Link
                      href="/auctions"
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black text-white hover:opacity-90"
                        ...
                        >
                          ...
                          <div className="w-14 h-14 rounded-xl overflow-hidden flex-shrink-0 relative bg-gray-100">
                            {entry.auction.image ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center">
                                <Gavel size={16} className="text-gray-300" />
                              </div>
                            )}
                          </div>
                          <div className="flex-1 min-w-0">
          ...
          <div style={{ borderTop: "1px solid #edeae2" }}>
            ...
            <div
              ...
              style={{ borderTop: "1px solid #edeae2", background: "#f9f8f6" }}
            >
              {AI_TOOLS.map((tool) => {
        ...
        <aside className="lg:col-span-2 flex flex-col">
          <div className="px-5 pt-6 pb-2">
            <button
              ...
              style={{
                background: "linear-gradient(140deg, #111010 0%, #1e1c18 100%)",
                border: "1px solid rgba(255,255,255,0.06)",
              }}
            >
              <div className="flex items-start justify-between mb-4">
                <span className="text-[1.75rem] leading-none select-none">
                  🎡
                </span>
                <span
          ...
          <div
            className="px-5 py-4"
            style={{ borderBottom: "1px solid #e6e3da" }}
          >
            <p
            ...
            <div className="space-y-0.5">
              {(
                ...
                <Link
                  key={g.label}
                  href={g.href}
                  className="group flex items-center gap-3 py-2.5 px-3 -mx-3 rounded-xl transition-all hover:bg-white hover:shadow-sm"
                >
                  <span className="text-lg w-7 text-center flex-shrink-0 leading-none select-none">
                    {g.emoji}
                  </span>
                  <div className="flex-1 min-w-0">
                    <p
            ...
            <Link
              href="/arena"
              className="group mt-4 flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-gray-50"
              style={{ border: "1px solid #e6e3da" }}
            >
              <Trophy size={14} className="text-amber-500 flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-xs font-black" style={{ color: "#0d0c09" }}>
                  Matchdays Arena
                </p>
                <p className="text-[10px]" style={{ color: "#a8a49a" }}>
                  Predict · Compete · Win
                </p>
              </div>
              <ChevronRight
          ...
          <div className="px-5 py-5 flex-1">
            <div className="flex items-center justify-between mb-4">
              <h3
                className="text-[11px] font-black uppercase tracking-[0.15em] flex items-center gap-1.5"
                style={{ color: "#78766e" }}
              >
                <Trophy size={11} className="text-amber-500" /> Rankings
              </h3>
              <div
                className="flex gap-px rounded-lg overflow-hidden"
                style={{ border: "1px solid #e6e3da" }}
              >
                ...
                <div key={gd.game}>
                  ...
                  <div className="space-y-px">
                    {gd.leaders.map((p) => (
                      <div
                        key={p.rank}
                        className="flex items-center gap-2 py-1.5 px-2 -mx-2 rounded-lg transition-colors hover:bg-white"
                      >
            ...
            >
              ...
              >
                ...
                You · {pts.toLocaleString()} pts
              </span>
              <Link
                href="/arena"
                className="text-[10px] font-bold transition-colors hover:text-black"
                style={{ color: "#a8a49a" }}
              >
                Full ranking →
              </Link>
